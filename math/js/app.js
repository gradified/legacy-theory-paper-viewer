/**
 * Main Application Entrypoint and State Controller for Mathematics Assessment Report.
 * Coordinates rendering, global report state, window postMessage listeners, and initialization.
 */
...
/**
 * Renders complete Mathematics Assessment Report view into the sheet container.
...
function renderReport(rawReportData) {
    ...
    <div class="masthead">
      <div class="masthead-top">
        <div class="brand-container">
          <img src="../logo_g.png" alt="Gradified Logo" class="brand-logo" onerror="this.src='logo_g.png'; this.onerror=function(){this.style.display='none'; document.getElementById('brandFallback').style.display='inline';};">
  ...
  setTimeout(renderAllMathFormulas, 50);
}
